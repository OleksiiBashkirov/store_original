...
drop table product;
alter table product add column sale_price decimal(8,2) check ( sale_price > 0 and sale_price <= price);
alter table product add column date_expired timestamp without time zone;
